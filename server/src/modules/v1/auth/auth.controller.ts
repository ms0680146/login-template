...
import { VerifiedGuard, FacebookOauthGuard, GoogleOauthGuard, JwtAuthGuard } from '../../../common/guards';
import { CurrentUser, Verified as Status } from '../../../common/decorators';
import { Providers, AccountStatus } from '../../../common/enums';
...
export class AuthController {
    ...
    resetPassword(
        ...
        return this.authService.sentResetPassword(email)
    }
